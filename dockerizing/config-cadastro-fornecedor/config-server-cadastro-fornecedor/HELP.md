...
* The original package name 'br.com.scheronlini.config-server-cadastro-fornecedor' is invalid and this project uses 'br.com.scheronlini.configservercadastrofornecedor' instead.
